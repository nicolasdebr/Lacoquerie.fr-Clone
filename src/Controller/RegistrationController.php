...
class RegistrationController extends AbstractController
{
    ...
    public function register(Request $request, UserPasswordEncoderInterface $passwordEncoder, GuardAuthenticatorHandler $guardHandler, LoginFormAuthentificationAuthenticator $authenticator): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $favoris = new Favoris($user->getId());
            ...
            $this->emailVerifier->sendEmailConfirmation('app_verify_email', $user,
                (new TemplatedEmail())
                    ->from(new Address('nicolas.debruyker@gmail.com', 'Boss'))
                    ->to($user->getEmail())
    ...
    /**
     * @Route("/confirmEmail",name="confirm")
     */
    public function ConfirmEmail()
    {
        return $this->render('registration/attente_validation_email.html.twig');
